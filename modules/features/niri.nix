        ...
        { pkgs, ... }:
        {
            packages.niri = inputs.wrapper-modules.wrappers.niri.wrap {
                ...
                settings = {
                    ...
                    cursor = {
                        xcursor-theme = config.flake.lib.cursor.name;
                        xcursor-size = config.flake.lib.cursor.size;
                    ...
                    binds = import ./_niri-binds.nix { inherit pkgs; };

                    window-rules = import ./_niri-rules.nix;
