{ lib, ... }:
{
  flake.modules.niri.niri.settings.binds =
    ...
    in
    {
      ...
      "Mod+WheelScrollDown" = scroll "focus-workspace-down";
      "Mod+WheelScrollUp" = scroll "focus-workspace-up";
      "Mod+Shift+WheelScrollDown" = scroll "move-column-to-workspace-down";
      "Mod+Shift+WheelScrollUp" = scroll "move-column-to-workspace-up";
